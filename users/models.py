...
class UserProfile(AbstractUser):
    ...
    gender = models.CharField(choices=(("male",u"男"),("female",u"女")),default="female",max_length=5)# 性别
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(choices=(("register","注册"),("forget",u"找回密码")),max_length=20)
    send_time = models.DateTimeField(default=datetime.now) # 括号要去掉，不然会根据model变异的时间生成，去掉才会根据class实例化的时间生成
